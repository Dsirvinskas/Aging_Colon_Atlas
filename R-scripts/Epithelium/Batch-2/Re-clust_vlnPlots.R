...
for (c in 2:9) {
  ...
  a = VlnPlot(Stem_TA, features = c("Lgr5", "Sox4", "Slc12a2","Ascl2","Mki67", "Pcna"), pt.size = 0.01)
  print(a)
  a = VlnPlot(Stem_TA, features = c("Lgr5", "Sox4", "Slc12a2","Ascl2","Mki67", "Pcna"), pt.size = 0)
  print(a)
  
  a = VlnPlot(Stem_TA, features = c("Dll1", "Atoh1","Chga", "Chgb", "Selenbp1", "Lgals3"), pt.size = 0.01)
  print(a)
  a = VlnPlot(Stem_TA, features = c("Dll1", "Atoh1","Chga", "Chgb", "Selenbp1", "Lgals3"), pt.size = 0)
  print(a)
  
  a = VlnPlot(Stem_TA, features = c("Reg4", "Muc2","Cd24a", "Dclk1", "Gsdmc4", "Spink1"), pt.size = 0.01)
  print(a)
  a = VlnPlot(Stem_TA, features = c("Reg4", "Muc2","Cd24a", "Dclk1", "Gsdmc4", "Spink1"), pt.size = 0)
  print(a)
